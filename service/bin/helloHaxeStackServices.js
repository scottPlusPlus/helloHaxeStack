...
JsonParser_$0.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "timestamp":
				this.loadObjectFieldReflect(($_=new JsonParser_$1(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"timestamp",assigned,pos);
				break;
			case "user":
	...
	,getAuto: function() {
		...
		value["timestamp"] = new JsonParser_$1([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
...
JsonParser_$2.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "email":
				this.loadObjectFieldReflect(($_=new JsonParser_$4(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"email",assigned,pos);
				break;
			case "id":
				this.loadObjectFieldReflect(($_=new JsonParser_$3(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"id",assigned,pos);
				break;
			case "passHash":
				this.loadObjectFieldReflect(($_=new JsonParser_$5(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"passHash",assigned,pos);
				break;
			case "salt":
				this.loadObjectFieldReflect(($_=new JsonParser_$3(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"salt",assigned,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		...
		value["email"] = new JsonParser_$4([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		value["salt"] = new JsonParser_$3([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		value["passHash"] = new JsonParser_$5([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		return value;
	}
...
JsonParser_$6.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "message":
				this.loadObjectFieldReflect(($_=new JsonParser_$5(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"message",assigned,pos);
				break;
			case "time":
				this.loadObjectFieldReflect(($_=new JsonParser_$7(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"time",assigned,pos);
				break;
			case "user":
				this.loadObjectFieldReflect(($_=new JsonParser_$3(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"user",assigned,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		...
		value["user"] = new JsonParser_$3([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		value["time"] = new JsonParser_$7([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		value["message"] = new JsonParser_$5([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		return value;
	}
...
JsonParser_$7.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonNumber: function(f,pos,variable) {
		var tmp = new JsonParser_$1(this.errors,this.putils,0);
...
JsonWriter_$0.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var decl = [indent + space + "\"timestamp\": " + new JsonWriter_$1(this.ignoreNullOptionals)._write(o.timestamp,space,level + 1,false,onAllOptionalNull),indent + space + "\"user\": " + new JsonWriter_$2(this.ignoreNullOptionals)._write(o.user,space,level + 1,false,onAllOptionalNull)];
...
JsonWriter_$2.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var decl = [indent + space + "\"id\": " + new JsonWriter_$4(this.ignoreNullOptionals)._write(o.id,space,level + 1,false,onAllOptionalNull),indent + space + "\"email\": " + new JsonWriter_$4(this.ignoreNullOptionals)._write(o.email,space,level + 1,false,onAllOptionalNull),indent + space + "\"salt\": " + new JsonWriter_$4(this.ignoreNullOptionals)._write(o.salt,space,level + 1,false,onAllOptionalNull),indent + space + "\"passHash\": " + new JsonWriter_$4(this.ignoreNullOptionals)._write(o.passHash,space,level + 1,false,onAllOptionalNull)];
		if(this.ignoreNullOptionals) {
...
JsonWriter_$7.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var decl = [indent + space + "\"user\": " + new JsonWriter_$4(this.ignoreNullOptionals)._write(o.user,space,level + 1,false,onAllOptionalNull),indent + space + "\"time\": " + new JsonWriter_$10(this.ignoreNullOptionals)._write(o.time,space,level + 1,false,onAllOptionalNull),indent + space + "\"message\": " + new JsonWriter_$4(this.ignoreNullOptionals)._write(o.message,space,level + 1,false,onAllOptionalNull)];
		if(this.ignoreNullOptionals) {
...
Services.handleOutcome = $hx_exports["handleOutcome"] = function(o,onFirst,onSecond) {
	switch(o._hx_index) {
	case 0:
		var v = o.data;
		onFirst(v);
...
chirp_ChirpService.prototype = {
	...
	,getChirps: function() {
		...
		var code = 500;
		var pos = { fileName : "src/chirp/ChirpService.hx", lineNumber : 42, className : "chirp.ChirpService", methodName : "getChirps"};
		if(code == null) {
			code = 500;
		}
	...
	,postChirp: function(actor,message) {
		var _gthis = this;
		zenlog_Log.Logger.debug("posting new chirp:  " + message,null,{ fileName : "src/chirp/ChirpService.hx", lineNumber : 49, className : "chirp.ChirpService", methodName : "postChirp"});
		if(message.length > 140) {
			var err = new tink_core_TypedError(406,"message should be 140 chars or less",{ fileName : "src/chirp/ChirpService.hx", lineNumber : 51, className : "chirp.ChirpService", methodName : "postChirp"});
		...
		var code = 500;
		var pos = { fileName : "src/chirp/ChirpService.hx", lineNumber : 65, className : "chirp.ChirpService", methodName : "postChirp"};
		if(code == null) {
			code = 500;
		}
	...
	,handleNewChirp: function(ev) {
		zenlog_Log.Logger.debug("handle new chirp:  " + ev.chirp.message,null,{ fileName : "src/chirp/ChirpService.hx", lineNumber : 76, className : "chirp.ChirpService", methodName : "handleNewChirp"});
		var p = this._recents.addChirp(ev.chirp);
		var code = 500;
		var pos = { fileName : "src/chirp/ChirpService.hx", lineNumber : 77, className : "chirp.ChirpService", methodName : "handleNewChirp"};
		if(code == null) {
			code = 500;
		}
		return tink_core_Promise.mapError(p,function(err) {
...
hawk_webserver_WebLogger.init = function() {
	...
	zenlog_Log.Logger.info("initting weblog for build " + "2021-02-13 19:02:54",null,{ fileName : "hawk/webserver/WebLogger.hx", lineNumber : 18, className : "hawk.webserver.WebLogger", methodName : "init"});
};
...
var haxe_crypto_HashMethod = $hxEnums["haxe.crypto.HashMethod"] = { __ename__ : true, __constructs__ : ["MD5","SHA1","SHA256"]
...
var jwt_JWTResult = $hxEnums["jwt.JWTResult"] = { __ename__ : true, __constructs__ : ["Valid","Invalid","Malformed"]
